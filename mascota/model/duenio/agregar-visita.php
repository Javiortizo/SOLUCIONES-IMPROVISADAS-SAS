...
$sql_vet = "SELECT usuario.ID_USU, usuario.PNOMBRE_USU, usuario.APELLIDOP_USU, usuario.IDENT_USU, tipousuario.USER_TUSU FROM usuario inner join tipousuario on usuario.ID_TUSU = tipousuario.ID_TUSU WHERE tipousuario.ID_TUSU=2 and usuario.ID_USU = '".$usua['ID_USU']."'";
