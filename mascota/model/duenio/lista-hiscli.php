    ...
    <body>
        ...
        <table border="1" class="Center">
            <form name= "frm_consultaVisita" method= "POST" autocomplete = "off">
                ...
                <?php
                    $sql="SELECT * from visita INNER JOIN usuario ON visita.ID_USU = usuario.ID_USU inner join estados on visita.ID_EST= estados.ID_EST INNER JOIN mascota ON mascota.ID_MAS = visita.ID_MAS where mascota.ID_USU = '".$usua['ID_USU']."' AND VISITA.ID_MAS = '".$_GET['id']."' ORDER BY visita.ID_VIS";
                    $i =0;
                ...
                <div class="usuariosHeader2">
                    ...
                    <div><a href="?id=<?php echo $resul['ID_VIS'] ?>" class="boton" onclick="window.open('lista-recibosmed.php?id=<?php echo $resul['ID_VIS'] ?>','','width= 1200,height=500, toolbar=NO');void(null);">Consultar</a></td>   
