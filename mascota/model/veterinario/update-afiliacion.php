...
<head>
    ...
    <title>Actualizar Afiliación</title>
</head>
<script> 
    function centrar() { 
    ...
    <table border="1" class="Center">
        <form name= "frm_consulta" method= "POST" autocomplete = "off">
            ...
            <tr>
                    ...
                    <td>
                        <select name="idmas">
                        <option value="<?php echo ($resul['ID_MAS']) ?>"><?php echo ($resul['NOM_MAS']. " - ". $resul['PNOMBRE_USU']. " ".$resul['APELLIDOP_USU']. " - CC".$resul['IDENT_USU']) ?></option>
                                <?php
                                    // Código php ciclo
                                    do{
