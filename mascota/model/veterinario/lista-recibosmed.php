    ...
    <body>
        ...
        <table border="1" class="Center">
            <form name= "frm_consulta" method= "POST" autocomplete = "off">
                ...
                <?php
                    $sql_consulta = "select * from recibosmed,visita,mascota,medicamentos where recibosmed.ID_MED = medicamentos.ID_MED AND recibosmed.ID_VIS = visita.ID_VIS AND visita.ID_MAS = mascota.ID_MAS AND VISITA.ID_USU= '".$usua['ID_USU']."' ORDER BY MASCOTA.NOM_MAS";
                    $i = 0;
