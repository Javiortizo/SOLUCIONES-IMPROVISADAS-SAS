    ...
    <body>
        ...
        <table border="1" class="Center">
            <form name= "frm_consultaVisita" method= "POST" autocomplete = "off">
                ...
                <?php
                    $sql="SELECT * FROM VISITA, MASCOTA, USUARIO, TIPOUSUARIO, ESTADOS WHERE VISITA.ID_MAS = MASCOTA.ID_MAS AND VISITA.ID_USU = USUARIO.ID_USU AND VISITA.ID_EST = ESTADOS.ID_EST AND USUARIO.ID_TUSU = TIPOUSUARIO.ID_TUSU AND USUARIO.ID_USU= '".$usua['ID_USU']."'";
                    $i =0;
